...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.dummy_button_1).setOnTouchListener(mDelayHideTouchListener);
        findViewById(R.id.dummy_button_2).setOnTouchListener(mDelayHideTouchListener);
    }
